...
INSERT INTO business_registration (business_registration_id, member_id, business_category_id, br_num, business_start_date, representative_name, company_name, address) VALUES (1, NULL, 1, 1234567890, '2021-02-15', '김철수', '카페 블리스', '서울특별시 강남구 테헤란로 327');
INSERT INTO business_registration (business_registration_id, member_id, business_category_id, br_num, business_start_date, representative_name, company_name, address) VALUES (2, NULL, 1, 2345678901, '2022-05-20', '박영희', '커피 코너', '서울특별시 마포구 양화로 147');
INSERT INTO business_registration (business_registration_id, member_id, business_category_id, br_num, business_start_date, representative_name, company_name, address) VALUES (3, NULL, 1, 3456789012, '2020-07-10', '이민수', '더 비너리', '부산광역시 해운대구 해운대해변로 302');
INSERT INTO business_registration (business_registration_id, member_id, business_category_id, br_num, business_start_date, representative_name, company_name, address) VALUES (4, NULL, 1, 4567890123, '2021-11-30', '최수정', '에스프레소 익스프레스', '대구광역시 중구 중앙대로 394');
INSERT INTO business_registration (business_registration_id, member_id, business_category_id, br_num, business_start_date, representative_name, company_name, address) VALUES (5, NULL, 1, 5678901234, '2019-01-25', '장민호', '카페 센트럴', '서울특별시 강동구 천호대로 1077');
INSERT INTO business_registration (business_registration_id, member_id, business_category_id, br_num, business_start_date, representative_name, company_name, address) VALUES (6, NULL, 1, 6789012345, '2018-09-12', '윤정희', '브루드 어웨이크닝', '광주광역시 서구 상무중앙로 42');
INSERT INTO business_registration (business_registration_id, member_id, business_category_id, br_num, business_start_date, representative_name, company_name, address) VALUES (7, NULL, 1, 7890123456, '2020-03-08', '정우성', '자바 정션', '인천광역시 연수구 인천타워대로 251');
INSERT INTO business_registration (business_registration_id, member_id, business_category_id, br_num, business_start_date, representative_name, company_name, address) VALUES (8, NULL, 1, 8901234567, '2022-06-18', '이지은', '더 커피 스팟', '대전광역시 유성구 대학로 99');
INSERT INTO business_registration (business_registration_id, member_id, business_category_id, br_num, business_start_date, representative_name, company_name, address) VALUES (9, NULL, 1, 9012345678, '2021-04-22', '김하늘', '컵 오브 조', '울산광역시 남구 삼산로 261');
INSERT INTO business_registration (business_registration_id, member_id, business_category_id, br_num, business_start_date, representative_name, company_name, address) VALUES (10, NULL, 1, 1234567891, '2023-01-05', '한지민', '카페 딜라이트', '경기도 성남시 분당구 판교역로 235');
